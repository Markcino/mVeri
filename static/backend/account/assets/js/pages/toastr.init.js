$(function () {
  ...
  $("#closeButton").click(function () {
    ...
    $("#showtoast").click(function () {
      let t;
      let o;
      const e = $("#toastTypeGroup input:radio:checked").val();
      let a = $("#message").val();
      const n = $("#title").val() || "";
      const s = $("#showDuration");
      const i = $("#hideDuration");
      const r = $("#timeOut");
      const l = $("#extendedTimeOut");
      const c = $("#showEasing");
      const p = $("#hideEasing");
      const d = $("#showMethod");
      const h = $("#hideMethod");
      const u = b++;
      const k = $("#addClear").prop("checked");
      (toastr.options = {
