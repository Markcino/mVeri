!(function (g) {
  ...
  (e.prototype.init = function () {
    const l = g("#event-modal");
    const t = g("#modal-title");
    const a = g("#form-event");
    var i = null;
    var r = null;
    ...
    const m = new FullCalendar.Calendar(v, {
    ...
    m.render(),
      g(a).on("submit", function (e) {
        ...
        g("#form-event :input");
        let t;
        const a = g("#event-title").val();
        const n = g("#event-category").val();
        !1 === s[0].checkValidity()
