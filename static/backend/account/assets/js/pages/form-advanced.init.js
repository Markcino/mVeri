!(function (a) {
  ...
  (e.prototype.init = function () {
    a(".select2").select2(),
      ...
      a(".select2-search-disable").select2({ minimumResultsForSearch: 1 / 0 }),
  ...
  $(function () {
    "use strict";
    const o = $(".docs-date");
    const c = $(".docs-datepicker-container");
    const r = $(".docs-datepicker-trigger");
    const l = {
      show: function (e) {
    ...
    o
      ...
      $(".docs-options, .docs-toggles").on("change", function (e) {
        ...
        const s = $(a);
        const n = s.attr("name");
        let i = a.type === "checkbox" ? a.checked : s.val();
        switch (n) {
          case "container":
            i ? (i = c).show() : c.hide();
            break;
